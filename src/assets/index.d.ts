...
declare type ISignatureSaveMode =
  typeof SignatureSaveMode[keyof typeof SignatureSaveMode];

declare type BuiltInDocumentEditorFooterItem =
  | 'cancel'
  | 'spacer'
  | 'save-as'
  | 'save'
...
declare module Record$1 {
  ...
  export interface Factory<TProps extends Object> {
    (values?: Partial<TProps> | Iterable<[string, any]>): Record$1<TProps> &
      Readonly<TProps>;
    new (values?: Partial<TProps> | Iterable<[string, any]>): Record$1<TProps> &
      Readonly<TProps>;
  }
 ...
 * `new` keyword during construction.
 */
declare function Record$1<TProps>(
...
declare class GoToAction extends Action {
  pageIndex: number;
  static defaultValues: IObject;
  constructor(args?: { pageIndex?: number });
}
...
declare class GoToRemoteAction extends Action {
  ...
  static defaultValues: IObject;
  constructor(args?: { relativePath?: string; namedDestination?: string });
}
...
declare class ResetFormAction extends Action {
  ...
  static defaultValues: IObject;
  constructor(args?: { fields?: List<string>; includeExclude?: boolean });
}
 ...
 */
declare type $Diff<T extends U, U extends object> = Pick<
  T,
...
declare type IDocumentComparisonSourceType =
...
declare type ISidebarPlacement =
...
declare type IToolbarPlacement =
...
declare type IShowSignatureValidationStatusMode =
...
declare type IModificationType =
...
declare type ItemCustomRenderer = (
...
declare type CustomUI = Partial<
  Record<IUIElement, CustomUIElementConfiguration>
>;
...
declare type RenderPageCallback = (
...
declare type DocumentIntegrityStatusType =
...
declare type CertificateChainValidationStatusType =
...
declare type SignatureValidationStatusType =
...
declare type DocumentValidationStatusType = $Keys<
  typeof DocumentValidationStatus
>;
...
declare type IElectronicSignatureCreationMode =
  typeof ElectronicSignatureCreationMode[keyof typeof ElectronicSignatureCreationMode];

declare type BuiltInDocumentEditorToolbarItem =
  | 'add'
  | 'remove'
  | 'duplicate'
  | 'rotate-left'
...
declare type AnnotationResizeStartCallback = (
...
declare type IInteractionMode =
  typeof InteractionMode[keyof typeof InteractionMode];

declare type OnOpenUriCallback = (
  uri: string,
...
declare type DefaultToolbarItemType =
  | 'pager'
  | 'layout-config'
  | 'pan'
  | 'zoom-out'
  ...
  | 'document-comparison'
  | 'export-pdf';
declare type BuiltInToolbarItemType =
  | DefaultToolbarItemType
  | 'layout-config'
  | 'marquee-zoom'
  | 'comment'
...
declare type ToolbarItemsSetter = (
  currentState: ToolbarItem[]
) => ToolbarItem[];
declare type StoredSignaturesSetter = (
...
declare class Instance {
  ...
  setSelectedAnnotation: (
    annotationOrAnnotationId?: (Annotation | ID$1) | null
  ) => void;
  ...
  signDocument: (
    arg0: SignaturePreparationData | null | undefined,
    arg1: TwoStepSignatureCallback | (SigningServiceData | null | undefined)
  ) => Promise<void>;
...
declare type IUIDateTimeElement =
...
declare type FormFieldInputAdditionalActionsType =
  FormFieldAdditionalActionsType & {
    onInput?: Action;
    onFormat?: Action;
  };
...
declare function serializeAnnotation<T extends Annotation>(
  annotation: T
): IObject;
