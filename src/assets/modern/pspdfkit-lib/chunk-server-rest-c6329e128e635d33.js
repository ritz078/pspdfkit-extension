...
(globalThis.webpackChunkPSPDFKit = globalThis.webpackChunkPSPDFKit || []).push([
  [4099],
  {
    82450: (a, t, e) => {
      'use strict';
      e.r(t), e.d(t, { RESTProvider: () => m });
      var s = e(96156),
        o = e(35369),
        i = e(51333),
        r = e(11706),
        n = e(81928);
      class l extends o.WV({
        alreadyLoadedPages: (0, o.D5)(),
        serverURL: null,
        authPayload: null,
        isLoaded: !1,
        isFormsEnabled: !0,
      ...
      var d = e(11171),
        ...
        h = e(46232);
      class m {
        constructor(a, t, { isFormsEnabled: e }) {
          (0, s.Z)(this, 'canCreateBackendOrphanWidgets', !0),
            (0, s.Z)(this, 'setDocumentHandleConflictCallback', () => {}),
            (this.state = new l({
              serverURL: a,
              authPayload: t,
              isFormsEnabled: e,
        ...
        async createAnnotation(a, t) {
          this._verifyLoaded();
          const { id: e, ...s } = (0, r.Hs)(a),
            o = { id: e, content: s };
          await this._request('/annotations', 'POST', o).then((a) => {
            if (200 !== a.status)
              throw new i.p2(
            ...
            a.json().then((a) => {
              if ('attachment_missing' === a.error) {
                ...
                return this._request('/annotations', 'POST', a).then((a) =>
                  a.json()
                );
              }
              return a;
        ...
        async setFormFieldValue(a) {
          this._verifyLoaded();
          const t = { id: (0, d.X)(a), content: (0, r.kr)(a) };
        ...
        async loadAnnotationsForPageIndex(a) {
          if ((this._verifyLoaded(), this.state.alreadyLoadedPages.has(a)))
            ...
            try {
              ...
              const s = (0, o.aV)().withMutations((a) => {
                e.annotations.forEach((t) => {
                  try {
                    a.push((0, r.vH)(t.id, t.content));
                  } catch (a) {
                    (0, i.um)(
              ...
              s.size > 0 &&
                ((0, h.k)(this.annotationCallbacks),
        ...
        async loadBookmarks() {
          if ((this._verifyLoaded(), this.state.loadBookmarksPromise))
            ...
            try {
              ...
              const e = (0, o.aV)().withMutations((a) => {
                t.bookmarks.forEach((t) => {
                  try {
                    a.push((0, n.i)(t.id, t.content));
                  } catch (a) {
                    (0, i.um)(
              ...
              e.size > 0 &&
                ((0, h.k)(this.bookmarkCallbacks),
                this.bookmarkCallbacks.createBookmarks(e, c.y));
            } catch (a) {
        ...
        async _initializeFormFieldValues() {
            ...
            t.formFieldValues
              .map(({ content: a }) => {
                try {
                  ...
                  return (
                    (0, i.um)(
                      `Skipped form field value ${a.name} from payload because an error occurred while deserializing.`,
                      a
                    ),
                    (0, i.um)(t),
                    null
          ...
          (0, h.k)(this.formFieldValueCallbacks),
            ...
            this.state.ignoredFormFieldNames.size
              ? this.formFieldValueCallbacks.setFormFieldValues(
                  e.filter((a) => {
                    var t;
                    return !(
                      null !== (t = this.state.ignoredFormFieldNames) &&
                      void 0 !== t &&
                      t.includes(a.name)
                    );
                  })
        ...
        _handleError(a, t) {
          (0, i.vU)(`Loading or updating ${t} failed:\n\n${a.message}`);
        }
        _request(a, t, e) {
          (0, h.k)(
