  ...
  [2333],
  {
    20251: (e, t, s) => {
      ...
      var i = s(96156),
        ...
        r = s(81928),
        c = s(51983);
      class l extends n.WV({
        clientId: '',
        userId: null,
        presenceContent: {},
      }) {}
      class d extends n.WV({
        status: 'offline',
        currentClient: null,
        clients: (0, n.D5)(),
      }) {}
      ...
      var A = s(44006),
        ...
        G = s(36091);
      class z {
        constructor(e, t, s, o = x.q) {
          (0, i.Z)(this, '_existingBookmarksIds', (0, n.l4)()),
            (0, i.Z)(this, '_existingFormFieldsIds', (0, n.l4)()),
            (0, i.Z)(this, '_existingFormFieldValuesIds', (0, n.l4)()),
            (0, i.Z)(this, '_existingCommentIds', (0, n.l4)()),
            (0, i.Z)(this, '_documentHandleConflictCallback', () => {}),
            (0, i.Z)(this, 'canCreateBackendOrphanWidgets', !0),
            (0, i.Z)(this, 'setDocumentHandleConflictCallback', (e) => {
              this._documentHandleConflictCallback = e;
            }),
            (0, i.Z)(this, 'setDocumentHandleOutdated', (e) => {
              this._setDocumentHandleOutdatedCallback = e;
            }),
            (0, i.Z)(this, 'onDocumentHandleConflict', () => {
          ...
          e = class {
            getRecords() {
              return (
                ...
                this._state.localRecordsContents
                  .map((e, t) => {
                    const { content: s, permissions: i, group: n } = e;
                    return { content: s, permissions: i, group: n, id: t };
                  })
                  .toList()
              );
            }
            createRecord(e, t, s, i) {
              return new Promise((n, o) => {
                ...
                this.enqueueChangeRequest(a);
              });
            }
            updateRecord(e, t, s) {
              return new Promise((i, n) => {
                if (!this.isKnownRecordId(e))
                  return n(new o.p2(`Record with ID: ${e} not found.`));
                const a = new w({
                  id: e,
                  content: t,
                  group: s,
            ...
            deleteRecord(e) {
              return new Promise((t, s) => {
                if (!this.isKnownRecordId(e))
                  return s(new o.p2(`Record with ID: ${e} not found.`));
                const i = new w({
                  id: e,
                  type: 'deleted',
                  resolve: t,
            ...
            constructor(e = new v(), t = I.ZP) {
              (0, i.Z)(this, '_recordsUpdatesCallback', () => {}),
                (0, i.Z)(this, '_acceptedRecordsResponseCallback', () => {}),
                (0, i.Z)(this, '_shouldFireRecordsUpdateCallback', !1),
                (0, i.Z)(this, 'onChanges', (e) => {
                ...
                (0, i.Z)(this, 'onAcceptedRecords', (e) => {
                  if (this._shouldFireRecordsUpdateCallback) {
                    const { created: t, updated: s, deleted: i } = e;
                ...
                (0, i.Z)(this, 'setOnDocumentHandleConflictCallback', (e) => {
                  if ('function' != typeof e)
          ...
          t = class {
            constructor(
              ...
              t = class {
                ...
                sendRequest(e, t) {
                  return new Promise((s, i) => {
                    ...
                    (this.requestsWaitingForAnswers =
                      this.requestsWaitingForAnswers.set(n, {
                        resolve: s,
                        reject: i,
                      })),
                ...
                onMessage(e) {
                  ...
                  if (this.isAuthenticated) {
                    ...
                    if (e.requestId) {
                      ...
                      switch (((0, p.k)(s), e.action)) {
                        case 'ok':
                          s.resolve(e.payload);
                          break;
                        case 'error':
                          s.reject(
                            new o.p2(e.payload.reason || 'Unknown error')
                          );
                          break;
                        default:
                          (0, p.k)(
                            !1,
                            `${e.action} is not a valid request reply`
                          );
                      }
                      this.requestsWaitingForAnswers =
                ...
                parseFrame(e) {
                  ...
                  return (
                    'info' !== t && (n = parseInt(t)),
                    { requestId: n, action: s, payload: JSON.parse(i) }
                  );
                }
                ...
                abortOpenRequests() {
                  this.requestsWaitingForAnswers.forEach((e) => {
                    e.reject(new o.p2('request aborted'));
                  }),
                    (this.requestsWaitingForAnswers = (0, n.D5)());
                }
                        ...
                        return (
                          ...
                          e.withMutations((s) => {
                            ...
                            const o = (0, n.D5)(
                              ...
                              null === (i = e.currentClient) || void 0 === i
                                ? void 0
                                : i.clientId,
                              e.currentClient
                            );
            ...
            onInfoClientPresence(e) {
              if (
                    ...
                    const s = e.clients.withMutations((s) => {
                      ...
                      if (t.clients.updated)
                        for (const i of t.clients.updated) {
                          ...
                          s.set(
                            t.clientId,
                            t.set('presenceContent', i.presence)
                          );
                        }
                      if (t.clients.left)
                ...
                let i = (0, n.aV)();
                e.clients.updated && (i = (0, n.aV)(e.clients.left)),
            ...
            updatePresence(e) {
              return new Promise((t, s) => {
                if ('online' !== this.getStatus())
                  return s(new o.p2('ClientsPresence is not connected'));
                this.connection
                  ...
                  .then(
                        ...
                        (function (e, t) {
                          ...
                          return e
                            ...
                            .setIn(
                              [
                                'clients',
                                null === (s = e.currentClient) || void 0 === s
                                  ? void 0
                                  : s.clientId,
                                'presenceContent',
                              ],
                    ...
                    () => {
                      s(new o.p2('Unable to update presence'));
                    }
                  );
              });
            }
        ...
        createAnnotation(e, t) {
          const { id: s, ...i } = (0, a.Hs)(e),
            { group: n, permissions: o, ...r } = i;
          return this._sync.createRecord(s, r, (0, a.Lw)(t), n);
        }
        createComment(e) {
          const { id: t, ...s } = (0, a.jA)(e),
            { group: i, permissions: n, ...o } = s;
          return (
            (this._existingCommentIds = this._existingCommentIds.add(t)),
            this._sync.createRecord(t, o, {}, i)
          );
        }
        async updateComment(e) {
          try {
            return await this.updateRecord((0, a.jA)(e));
          } catch (e) {
            if (!(e instanceof o.p2)) throw e;
          }
        }
        deleteComment(e) {
          return (
        ...
        async updateRecord(e) {
          var t;
          const { id: s, permissions: i, group: n, ...o } = e;
          return this._getState &&
            this._getState() &&
            null !== (t = this._getState().backend) &&
            void 0 !== t &&
            ...
            : this._sync.updateRecord(s, o, n);
        }
        async updateAnnotation(e) {
          try {
            return await this.updateRecord((0, a.Hs)(e));
          } catch (e) {
            if (!(e instanceof o.p2)) throw e;
          }
        }
        ...
        async updateBookmark(e) {
          const { id: t, ...s } = (0, r.a)(e);
          try {
            return await this._sync.updateRecord(t, s);
          } catch (e) {
            if (!(e instanceof o.p2)) throw e;
          }
        }
        ...
        createFormField(e) {
          const { id: t, ...s } = (0, a.vD)(e),
            { group: i, permissions: n, ...o } = s;
          return (
            (this._existingFormFieldsIds = this._existingFormFieldsIds.add(t)),
            this._sync.createRecord(t, o, {}, i)
          );
        }
        async updateFormField(e) {
          try {
            return await this.updateRecord((0, a.vD)(e));
          } catch (e) {
            if (!(e instanceof o.p2)) throw e;
          }
        }
        ...
        async setFormFieldValue(e) {
          const t = (0, a.kr)(e);
          try {
            return await this._sync.updateRecord((0, V.X)(e), t);
          } catch (e) {
            if (!(e instanceof o.p2)) throw e;
          }
        }
                ...
                () => {
                  this._hasLoadedInitialRecords ||
                    (this._sync.onRecordsUpdates(
                      (e, t, s) => this._onRecordsUpdates(e, t, s, c.z),
        ...
        _filterRecords(e) {
          return e.filter(
            ({ content: e }) => this._formsEnabledInConfig || !(0, a._Q)(e)
          );
        }
        _onRecordsUpdates(e, t, s, i) {
          ...
          let d = (0, n.aV)(),
            ...
            k = (0, n.l4)(),
            _ = (0, n.l4)();
          const f = this._getState ? this._getState() : void 0;
          let C = e,
            g = t,
            b = s;
          if (f && f.backend && f.backend.isCollaborationPermissionsEnabled()) {
            C = C.filter(({ content: e }) => !!e);
            const e = [];
            t.forEach((t, s) => {
              t.content
                ? P(f, t) || ((C = C.push(t)), e.push(s))
                : P(f, t)
          ...
          let F = (0, n.aV)().withMutations((e) => {
            this._filterRecords(C).forEach(
              ({ id: t, content: s, permissions: i, group: n }) => {
                const u = { permissions: i, group: n };
                try {
                  (0, a._Q)(s)
                    ? (l.push((0, a.IN)(t, s, u)),
                      (this._existingFormFieldsIds =
                        this._existingFormFieldsIds.add(t)))
                    : (0, a.Qp)(s)
                    ? ((d = d.push((0, a.u9)(s))),
                      (this._existingFormFieldValuesIds =
                        this._existingFormFieldValuesIds.add(t)))
                    : (0, a.l9)(s)
                    ? ((c = c.push((0, r.i)(t, s))),
                      (this._existingBookmarksIds =
                        this._existingBookmarksIds.add(t)))
                    : (0, a.Fd)(s)
                    ? ((this._existingCommentIds =
                        this._existingCommentIds.add(t)),
                      (h = h.push((0, a.Mu)(t, s, u))))
                    : (0, a.$T)(s) ||
                      (0, a._o)(s) ||
                      e.push((0, a.vH)(t, s, u));
                } catch (e) {
                  (0, o.um)(
                    `Skipped creating record #${t} from payload because an error occurred while deserializing.`,
                    s
                  ),
                    (0, o.um)(e);
                }
          ...
          const y = !f || (0, G.xW)(f.features, f.signatureFeatureAvailability);
          l.length > 0 &&
            ((0, o.kG)(this._formFieldCallbacks),
            f && !y
              ? this._formFieldCallbacks.createFormFields(
                  (0, n.aV)(l.filter((e) => !(e instanceof D.Yo))),
                  i
                )
              : this._formFieldCallbacks.createFormFields((0, n.aV)(l), i)),
            F.size > 0 &&
              ((0, o.kG)(this._annotationCallbacks),
              f &&
                !y &&
                (F = F.filter((e) => {
                  if (!(e instanceof U.x_)) return e;
                  const t =
                    l.find((t) => t.name === e.formFieldName) ||
                    f.formFields.get(e.formFieldName);
                  return !(t && t instanceof D.Yo);
                })),
              this._annotationCallbacks.createAnnotations(F, (0, n.D5)(), i)),
            d.size > 0 &&
              ((0, o.kG)(this._formFieldValueCallbacks),
              f &&
                !y &&
                (d = d.filter((e) => {
                  const t =
            ...
            h.size > 0 &&
              ((0, o.kG)(this._commentCallbacks),
              this._commentCallbacks.createComments(h, i)),
            c.size > 0 &&
              ((0, o.kG)(this._bookmarkCallbacks),
              this._bookmarkCallbacks.createBookmarks(c, i));
          const w = (0, n.aV)().asMutable(),
            I = [],
            v = [],
            R = [],
            x = (0, n.aV)().withMutations((e) => {
              this._filterRecords(g).forEach(
                ({ id: t, content: s, group: i, permissions: n }) => {
                  const c = { permissions: n, group: i };
                  try {
                    if ((0, a._Q)(s))
                      try {
                        I.push((0, a.IN)(t, s, c));
                        ...
                        (p = p.add(t)),
                          (0, o.um)(
                            `Skipped updating form field #${t} from payload because an error occurred while deserializing. To avoid issues, we have removed the previous version from the application state.`,
                            s
                          ),
                          (0, o.um)(e);
                      }
                      ...
                      try {
                        ...
                        (k = k.add(t)),
                          (0, o.um)(
                            `Skipped updating form field value #${t} from payload because an error occurred while deserializing. To avoid issues, we have removed the previous version from the application state.`,
                            s
                          ),
                          (0, o.um)(e);
                      }
                      ...
                      try {
                        ...
                        (m = m.add(t)),
                          (0, o.um)(
                            `Skipped updating bookmark #${t} from payload because an error occurred while deserializing. To avoid issues, we have removed the previous version from the application state.`,
                            s
                          ),
                          (0, o.um)(e);
                      }
                      ...
                      try {
                        ...
                        (_ = _.add(t)),
                          (0, o.um)(
                            `Skipped updating comment #${t} from payload because an error occurred while deserializing. To avoid issues, we have removed the previous version from the application state.`,
                            s,
                            e
                          );
                      }
                    else e.push((0, a.vH)(t, s, c));
                  } catch (e) {
                    (u = u.add(t)),
                      (0, o.um)(
                        `Skipped updating annotation #${t} from payload because an error occurred while deserializing. To avoid issues, we have removed the previous version from the application state.`,
                        s
                      ),
                      (0, o.um)(e);
                  }
          ...
          x.size > 0 &&
            ((0, o.kG)(this._annotationCallbacks),
            this._annotationCallbacks.updateAnnotations(x)),
            w.size > 0 &&
              ((0, o.kG)(this._bookmarkCallbacks),
              this._bookmarkCallbacks.updateBookmarks(w)),
            I.length > 0 &&
              ((0, o.kG)(this._formFieldCallbacks),
              this._formFieldCallbacks.updateFormFields((0, n.aV)(I))),
            v.length > 0 &&
              ((0, o.kG)(this._formFieldValueCallbacks),
              this._formFieldValueCallbacks.setFormFieldValues((0, n.aV)(v))),
            R.length > 0 &&
              ((0, o.kG)(this._commentCallbacks),
              this._commentCallbacks.updateComments((0, n.aV)(R))),
            (u = u.concat(
              b
                .filter(
                  (e) =>
            ...
            _.size > 0 &&
              ((0, o.kG)(this._commentCallbacks),
              this._commentCallbacks.deleteComments(_));
        }
        _onAcceptedRecords(e, t) {
          ...
          e.isEmpty() || e.forEach(h),
            ...
            i.length > 0 &&
              ((0, o.kG)(this._annotationCallbacks),
              this._annotationCallbacks.updateAnnotations((0, n.aV)(i), !0)),
            a.length > 0 &&
              ((0, o.kG)(this._commentCallbacks),
              this._commentCallbacks.updateComments((0, n.aV)(a))),
            r.length > 0 &&
              ((0, o.kG)(this._formFieldCallbacks),
              this._formFieldCallbacks.updateFormFields((0, n.aV)(r))),
            c.length > 0 &&
              ((0, o.kG)(this._annotationCallbacks),
              this._annotationCallbacks.deleteAnnotations((0, n.l4)(c), !0)),
            l.length > 0 &&
              ((0, o.kG)(this._commentCallbacks),
              this._commentCallbacks.deleteComments((0, n.l4)(l))),
            d.length > 0 &&
              ((0, o.kG)(this._formFieldCallbacks),
              this._formFieldCallbacks.deleteFormFields((0, n.l4)(d)));
        }
        onClientsChange(e) {
          if ('function' != typeof e)
            throw new TypeError('Callback must be a function');
